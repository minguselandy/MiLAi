...
> Bundle：`1.0.0-candidate.5`  
> Captured：`2026-08-17`（Asia/Shanghai）  
> Status：`CANDIDATE / NO-GO FOR SCHEMA FREEZE`

## MiLAi sources

| Input | SHA-256 at baseline |
| --- | --- |
| `MiLAi_Logical_Architecture_v1_设计文档.md` | `3e96d9870826f727ff4d68e3d787855a979813b37ee8d5d3bb03fb8f207b0e88` |
| `MiLAi_Lean_V1_实施合同.md` | `fbb87578e6b3a47584fc8e92e069c12b2735c8e13b27de0c0e6ac8ea9fcab925` |
| `MiLAi_Lean_V1_设计开发_GOALS.md` | `39563beff63d0f8b166a6dc08f0512f4287c31ad6824cf1078e5ad2f65dedcd7` |
...
These are candidate evidence, not performance SLA or production certification.
