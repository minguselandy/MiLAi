...
def test_query_first_resolve_timeout_is_typed_and_never_retried() -> None:
    client = _SequenceAsyncClient(
        [
            _Response(200, _capabilities()),
...
def test_typed_request_serializes_datetime_and_proposal_draft_validates_locally() -> None:
