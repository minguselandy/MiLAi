...
- Local loopback and MCP stdio only. No TLS/OAuth/remote HTTP MCP, browser extension or public SaaS.
...
- MCP protocol compatibility is verified for `2026-07-28` and `2025-11-25`; Streamable HTTP is not
  enabled.
