...
def _raw(
    ...
    *,
    ...
    return {
        ...
        "normalized_subjects": ["smoker"],
        "normalized_predicate": "buy",
        "normalized_value": "smoker",
...
def test_unique_unicode_quote_derives_python_offsets() -> None:
    content = "用户说\uff1aI bought a smoker on February 26th ☕"
    quote = "I bought a smoker on February 26th"
...
def test_non_unique_quote_rejects_only_that_hypothesis() -> None:
    hypothesis, disposition = materialize_hypothesis_v03(
        ...
        hypothesis_id="b" * 64,
        raw=_raw("smoker"),
        content="smoker and another smoker",
        source_observed_at="2024-03-01T00:00:00+00:00",
    )
...
def test_naive_event_time_uses_only_source_timezone_context() -> None:
    raw = _raw(
        "I bought a smoker on February 26th",
        event_time={
            "start": "2024-02-26",
            "end": "2024-02-26",
    ...
    hypothesis, disposition = materialize_hypothesis_v03(
        ...
        hypothesis_id="c" * 64,
        raw=raw,
        content="I bought a smoker on February 26th",
    ...
    rows = [
        {
            ...
            "hypotheses": [
                ...
                _raw("I bought a smoker"),
            ],
            "ambiguity_reasons": [],
        }
    ]
    adapter = _FixtureAdapter(rows)
    content = "I bought a smoker yesterday."
