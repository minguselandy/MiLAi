...
class EvidenceAcquisitionExecution(BaseModel):
...
class EvidenceAcquisitionExecutor:
    ...
    def compile_existing_results(
        ...
        *,
        ...
        binding_backed_operator = formation_binding_operator or (
        ...
        derived_result = (
            None
            if formation_binding_operator
            else self._derived_result(
                query_plan,
                compiled_results,
                range_scan=range_scan,
            )
        )
        if binding_backed_operator and grounded_formation_semantics is None:
        ...
        if type_directed_semantics:
            ...
            bindings = bind_requirements(
                ...
                compatibility_profile=(
                    "dg22-v0.2" if grounded_formation_semantics is not None else "legacy-v0.1"
                ),
            )
        ...
        attribution = _candidate_requirement_attribution(
            query_ir.requirements,
            bindings,
            interpretations,
            spans,
        ...
        return EvidenceAcquisitionExecution(
            ...
            candidate_requirement_attribution=attribution,
            type_directed_semantics=type_directed_semantics,
    ...
    def _execute_probe(
        ...
        *,
        ...
        if probe.channel == "EVIDENCE_DENSE":
            if acquisition_plan.global_constraints.event_occurrence_range is not None:
        ...
        ranked = rank_evidence_turns(apply_probe_source_policy(probe, items), probe_query(probe))
            ...
            if bounded is None or temporal_query_axis(query_plan) != "EVENT_OCCURRENCE_TIME":
                ...
                try:
                    ...
                    if not isinstance(source_scan, Mapping):
                        ...
                        if derived is None:
                            derived = execute_query_operator(query_plan, scanned)
