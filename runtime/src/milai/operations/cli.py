...
def _parser() -> argparse.ArgumentParser:
    ...
    agent.add_argument("--transport", choices=("stdio",), default="stdio")
    agent.add_argument(
        "--profile",
        choices=(
            "reader-lite",
...
def main() -> None:
    ...
    try:
        if args.command == "init":
            ...
            result = _agent_config(args.profile)
...
def _agent_config(profile: str) -> dict[str, object]:
    token_profile = "reader" if profile in {"reader-lite", "reader-detail"} else profile
