"""Separate v18 source/run identity without mutating frozen earlier locks."""
...
REFERENCE = LAB / "data/manifests/milai-m1-v18-reference.json"
B1_LOCK = LAB / "data/locks/langmem-b1.lock.json"
BASIS_V17_LOCK = LAB / "data/locks/milai-m1-v17.lock.json"
...
REQUIRED_RUNTIME = {
    ...
    "tools/run_milai_m1_v18.py",
    "tools/inspect_milai_m1_v18.py",
    "configs/milai-m1-v18.json",
...
def verify_m1_lock(lock_path: Path, config_path: Path) -> tuple[dict[str, Any], dict[str, Any]]:
    ...
    if (reference["reference_artifacts_sha256"]["data/locks/milai-m1-v17.lock.json"]
            != sha256_file(BASIS_V17_LOCK)):
        raise ValueError("M1_REFERENCE_V17_LOCK_CHANGED")
