...
from run_v0223_current_calibration import read_worker_evidence  # noqa: E402


@pytest.fixture
def child_files(tmp_path):
    position = {"instance": "k3-s1", "variant": "candidate", "mode": "S"}
...
def test_complete_child_limit_stops_before_next_position(tmp_path, monkeypatch, seconds):
    ...
    import run_v0223_current_calibration as parent
    ...
    assert terminal["status"] == "CURRENT_CALIBRATION_STOP"
