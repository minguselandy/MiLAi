...
CPU_BASE = Path("/cra/memory/mx_memory/evidence/v0224/20260913-gate-a-bundle-v2")
INSTANCE_NAMES = frozenset({"bundle-v2-slice"})
CPU_REVISION = "V0224_BUNDLE_AUTHORITY_CPU_V2"
