...
def main():
    ...
    from run_v0223_admission_pair import CALIBRATION_ORDER
    ...
    from v0223_cpu_batch import CPU_BASE
    ...
    for instance, mode in (*CALIBRATION_ORDER, ("k1-prefix", "S")):
        ...
        normalized_plan = normalize_plan(plan, instance, public_by_root, resolve_p4_spec)
    ...
    contract.update(
        ...
        assembly_source={
            "path": str(LAB / "tools/assemble_v0223_k0.py"),
            "sha256": sha(LAB / "tools/assemble_v0223_k0.py"),
        },
    )
