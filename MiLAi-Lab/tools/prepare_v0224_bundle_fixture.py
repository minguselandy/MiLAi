...
def _prepare(static_authority):
    ...
    from v0224_bundle_cpu_batch import (
        CPU_REVISION,
        OfflineBatch,
        StaticAuthority,
    ...
    with BundleReadScope(**static_authority.scope_arguments()) as scope:
        ...
        # The external authority pins are never replaced by locally discovered hashes.
        input_pins[str(static_authority.bundle_path)] = static_authority.bundle_sha256
        input_pins[str(static_authority.receipt_path)] = static_authority.receipt_sha256
...
def main():
    ...
    enable_cpu_network_guard()
    from v0224_bundle_cpu_batch import StaticAuthority
