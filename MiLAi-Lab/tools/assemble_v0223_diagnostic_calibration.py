...
def main():
    ...
    from run_v0223_diagnostic_admission import CALIBRATION_ORDER
    ...
    from v0223_diagnostic_cpu_batch import CPU_BASE
    ...
    for field in (
        ...
        "K1_cost_evidence",
        "prior_K2_review",
        "prior_current_calibration_review",
        "observation_revision_contract",
    ):
    ...
    contract.update(
        status="INVENTORY_DIAGNOSTIC_CALIBRATION_REVIEW_REQUIRED",
        ...
        assembly_source={
            "path": str(LAB / "tools/assemble_v0223_diagnostic_calibration.py"),
            "sha256": sha(LAB / "tools/assemble_v0223_diagnostic_calibration.py"),
        },
    )
