...
def prepare(gate_path, gate_sha256):
    ...
    from v0224_live_completion_batch_v2 import (
        GATE_A_STATUS,
        LIVE_MODE,
        LIVE_REVISION,
        ROOT,
    ...
    with AdmissionReadScope() as scope:
        ...
        entries += [
            LAB / "tools" / name
            for name in (
                "v0224_live_completion_batch_v2.py",
                "v0224_live_http.py",
                "run_v0224_live_completion_v2.py",
                "prepare_v0224_live_completion_v2.py",
            )
        ]
        entries.append(LAB / "tests/unit/test_v0224_live_completion_v2.py")
