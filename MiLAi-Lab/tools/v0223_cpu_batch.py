...
CPU_BASE = Path("/cra/memory/mx_memory/evidence/v0224/20260913-gate-a-v1")
INSTANCE_NAMES = frozenset({
    "k1-u1", "k1-s1", "k1-s2", "k1-u2", "k1-u3", "k1-s3",
    "k1-prefix", "k2-original", "k2-candidate", "k3-cold",
})
CPU_REVISION = "V0223_COARSE_CPU_V1"
