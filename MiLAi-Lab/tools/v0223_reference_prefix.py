...
U/S modes execute these same named wrappers and coverage counters.
"""
...
def run_reference_prefix(batch_factory, directory: Path, *, public_loader=None, full_prefix=False):
    ...
    if primary is not None and not isinstance(primary, Exception):
        raise primary
    result["runtime_guard_union_ns"] = sum(result["runtime_guard_wall_ns"])
    return result
