...
CPU_BASE = Path("/cra/memory/mx_memory/evidence/v0224/20260913-gate-a-k2-v1")
INSTANCE_NAMES = frozenset({"k2-base", "k2-edit"})
CPU_REVISION = "V0223_K2_CPU_V1"
