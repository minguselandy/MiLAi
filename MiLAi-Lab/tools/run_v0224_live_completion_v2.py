...
def _batch(root, binding, authority):
    from v0224_live_completion_batch_v2 import Batch
...
def stop_batch(root, binding, batch, exc):
    ...
    from v0224_live_completion_batch_v2 import ROOT as CPU_ROOT
    from v0224_live_completion_batch_v2 import Batch as OfflineBatch
...
def run_stage(
    ...
    from v0220_provider_hardened import ProviderStop
    from v0224_live_completion_batch_v2 import LIVE_MODE
    ...
    try:
        ...
        for spec in batch.plan[stage]:
            ...
            remaining = min(3600.0, deadline - time.time())
            if remaining <= 0:
...
def validate_contract(value):
    ...
    require(
        ...
        and value["execution_revision"] == "V0224_BC_LIVE_COMPLETION_02",
