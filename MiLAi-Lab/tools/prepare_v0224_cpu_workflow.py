...
REQUIRED_TESTS = (
    *OLD_REQUIRED_TESTS,
    "test_v0224_cpu_workflow_batch.py",
    "test_prepare_v0224_cpu_workflow.py",
    "test_run_v0224_cpu_workflow.py",
)
R04_EVIDENCE_PINS = {
    **OLD_R04_EVIDENCE_PINS,
    ...
    (
        "/cra/memory/mx_memory/evidence/v0224/20260913-a-scope-digest-v2/"
        "four-turn-shape-selection.json"
...
def _prepare(static_authority):
    ...
    from v0224_cpu_workflow_batch import (
        CPU_REVISION,
        INSTANCE_NAMES,
        OfflineBatch,
        StaticAuthority,
...
def fixture_main(argv=None):
    ...
    enable_cpu_network_guard()
    from v0224_cpu_workflow_batch import StaticAuthority
...
def run_preparation(contract_path, contract_sha256, *, approval_fd=0):
    ...
    from v0224_cpu_workflow_batch import INSTANCE_ORDER
    ...
    try:
        ...
        for instance in INSTANCE_ORDER:
            ...
            argv = [
                sys.executable,
                str(tools / "prepare_v0224_cpu_workflow.py"),
                "fixture",
                "--instance",
                instance,
                "--bundle-path",
