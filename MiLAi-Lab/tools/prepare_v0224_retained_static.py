"""Fixed A1/K3 fixture and six-A1 preparation controller; no implicit execution."""
...
from run_v0224_retained_static import R05_EVIDENCE_PINS
...
REQUIRED_TOOLS = (
    *OLD_REQUIRED_TOOLS,
    "v0224_retained_static_scope.py",
    "v0224_retained_static_batch.py",
    "prepare_v0224_retained_static.py",
    "run_v0224_retained_static.py",
)
REQUIRED_TESTS = (
    *OLD_REQUIRED_TESTS,
    "test_v0224_retained_static_scope.py",
    "test_v0224_retained_static_batch.py",
    "test_prepare_v0224_retained_static.py",
    "test_run_v0224_retained_static.py",
)
R04_EVIDENCE_PINS = {**OLD_R04_EVIDENCE_PINS, **R05_EVIDENCE_PINS}
...
def _prepare(static_authority):
    ...
    with BundleReadScope(**static_authority.scope_arguments()) as scope:
        ...
        plan["testbed_guarantee"] = TESTBED_GUARANTEE
    ...
    with OfflineBatch(root, digest, static_authority=static_authority) as batch:
        batch.initialize()
        ...
        result = {
            "status": "R05_RETAINED_STATIC_FIXTURE_ONLY_NOT_ENGINEERING_OR_GATE_A_PASS",
            "root": str(root),
            ...
            "retained_static_authority": batch.retained_authority_stats(),
        }
    if not batch._static_released:
        raise ValueError("EXPLICIT_RETAINED_AUTHORITY_RELEASE_REQUIRED")
    result["retained_static_release_completed"] = True
...
def fixture_main(argv=None):
    ...
    enable_cpu_network_guard()
    from v0224_retained_static_batch import StaticAuthority
...
def run_preparation(contract_path, contract_sha256, *, approval_fd=0):
    ...
    from v0224_retained_static_batch import INSTANCE_ORDER
    ...
    try:
        ...
        for instance in INSTANCE_ORDER:
            ...
            argv = [
                sys.executable,
                str(tools / "prepare_v0224_retained_static.py"),
                "fixture",
                "--instance",
                instance,
                "--bundle-path",
