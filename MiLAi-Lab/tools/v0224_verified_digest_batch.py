...
from v0224_verified_digest_scope import BundleReadScope, _canonical, _digest

# Fixed prospective instances, never selected by model input.
CPU_BASE = Path("/cra/memory/mx_memory/evidence/v0224/20260913-gate-a-scope-digest-v1")
INSTANCE_ORDER = (
    "digestv1-d1-u1",
    "digestv1-d1-s1",
    "digestv1-d1-s2",
...
CPU_REVISION = "V0224_VERIFIED_DIGEST_CPU_V1"
