...
INSTANCE = "bundle-v2-slice"
CPU_ROOT = Path("/cra/memory/mx_memory/evidence/v0224/20260913-gate-a-bundle-v2") / INSTANCE
...
def _run_slice(contract, out, phases, details):
    ...
    from v0224_bundle_cpu_batch_v2 import OfflineBatch, StaticAuthority, selected_root
