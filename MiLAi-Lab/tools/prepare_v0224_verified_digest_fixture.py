...
REQUIRED_TOOLS = (
    ...
    "v0224_verified_digest_scope.py",
    "v0224_verified_digest_lineage.py",
    "v0224_verified_digest_batch.py",
    "prepare_v0224_verified_digest_fixture.py",
    "run_v0224_verified_digest_preparation.py",
    "run_v0224_verified_digest_calibration.py",
)
REQUIRED_TESTS = (
    ...
    "test_v0224_verified_digest_scope.py",
    "test_v0224_verified_digest_workpoint.py",
    "test_run_v0224_verified_digest_calibration.py",
)
...
R04_EVIDENCE_PINS = {
    (
        "/cra/memory/mx_memory/evidence/v0224/20260913-a-runtime-union-v1/"
        "independent-runtime-union-calibration-review.json"
    ): "b453e5f2a913c1c621262c776dcd83fd305c63e0b4b68f8b8c0f8c9843710765",
    (
        "/cra/memory/mx_memory/evidence/v0224/20260913-a-parse-split-v1/"
        "independent-parse-split-result-review.json"
    ): "4a910448b17e1c430a5c8c56ae579cb5c4ff29b40ffd0f05ff56dc62ecba0c9a",
}
...
def _prepare(static_authority):
    ...
    from v0224_verified_digest_batch import (
        CPU_REVISION,
        INSTANCE_ORDER,
        OfflineBatch,
        StaticAuthority,
