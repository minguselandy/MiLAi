...
OLD_SUFFIX = "candidate.4.16-2026-08-22.json"
NEW_SUFFIX = "candidate.4.17-2026-08-22.json"
...
def build_receipt() -> dict[str, Any]:
    ...
    return {
        ...
        "reason_codes": [
            "ALLOW_ONLY_ZERO_OR_ONE_EXACT_CANONICAL_STDERR_DIAGNOSTIC",
            "REJECT_DUPLICATE_PREFIX_SUFFIX_CRLF_AND_UNDECODABLE_STDERR",
            "FREEZE_CODEX_EXECUTABLE_AND_HELPER_ROOT_UID_GID_MODE_IN_POLICY",
            "SIGN_AND_REPLAY_CODEX_EXECUTABLE_AND_HELPER_GID",
        ...
        "active_identity_suffix": "candidate.4.17",
    }


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Freeze candidate.4.17 identity supersession"
    )
