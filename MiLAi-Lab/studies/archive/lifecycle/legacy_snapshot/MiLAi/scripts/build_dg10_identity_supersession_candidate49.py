...
OLD_SUFFIX = "candidate.4.12-2026-08-22.json"
NEW_SUFFIX = "candidate.4.13-2026-08-22.json"
REVISE = ROOT / (
...
def build_receipt() -> dict[str, Any]:
    ...
    if not (
        ...
        and revise.get("attempt_id") == "candidate.4-primary-011"
        ...
        and result.get("open_p2_count") == 2
    ):
        raise remediation.RemediationError("candidate.4.9 revise receipt drift")
    ...
    return {
        ...
        "remediated_audit_attempt": "candidate.4-primary-011",
        "reason_codes": [
            "AI_RUNS_REQUIRE_PINNED_CODEX_PIDFD_PROCFS_AND_DIRECT_PIPE_ATTESTATION",
            "CALLER_SELECTED_AND_LEGACY_AI_ATTEMPTS_FAIL_CLOSED",
            "TEST_ACCESS_IMPORT_REPLAYS_PROTECTED_EXECUTION_PROVENANCE",
            "GENERIC_R3_ACCEPTANCE_RECEIPTS_ARE_DENIED",
            "FIXED_R3_IMPORTER_AND_AUTHORIZATION_DEEP_REPLAY_ARE_REQUIRED",
            "POST_R3_SUCCESS_STATUS_EXITS_ZERO",
            "TEST_ACCESS_CLI_PARSER_HAS_ONE_ATTEMPT_LEDGER_OPTION",
        ],
        ...
        "active_identity_suffix": "candidate.4.13",
    }


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Freeze candidate.4.13 identity supersession"
    )
