...
def collect_hash_errors(
    ...
    if manifest.get("architecture_version") != "1.0.0-candidate.5":
    ...
    if manifest.get("freeze_status") != "NO-GO":
        errors.append("manifest freeze_status must be NO-GO")
...
def main() -> int:
    ...
    if errors:
        ...
        return 1
    print("MiLAi architecture lock verification: PASS (candidate, not frozen)")
    return 0
