    ...
    return jsonify(
        {
            ...
            "features": {
                "host_notes_v1": True,
                "evidence_project_read": True,
                "evidence_project_browse": True,
                ...
                "host_cognitive_state": True,
                "host_cognitive_state_cas": True,
                "host_cognitive_state_audit_default": True,
                "host_execution_event_journal": True,
                "host_execution_event_shadow_only": True,
                "retrieval_continuation_v0_1": (
                    settings.retrieval_continuation_v0_1_enabled
                ),
                "intra_source_acquisition_v0_1_mode": (
                    settings.intra_source_acquisition_v0_1_mode
                ),
