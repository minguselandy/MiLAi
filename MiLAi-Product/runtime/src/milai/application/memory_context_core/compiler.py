"""Memory-context compiler orchestration."""
...
from milai.application.memory_context_core.activation import (
    _admissible_conditional_gain,
    _breadth_first_binding_spans,
    _canonical_item_identity,
    _canonical_item_sort_key,
    _conditional_activation_thresholds,
    _derived_operand_views,
    _evidence_views,
    _fallback_decision_snapshot,
    _local_context_activation,
    _normalized_unit_semantics,
    _query_terms,
    _stable_evidence_views,
...
from milai.application.memory_context_core.rendering import (
    ...
    _open_issue_ids,
    _render_context,
    _reserve_required_windows,
)
from milai.application.memory_context_core.semantics import (
    _query_ir_enumerates_members,
    _reader_semantic_value,
)
from milai.application.memory_context_core.trace import (
    _acquired_candidate_trace,
    _admitted_evidence_trace,
    _bound_evidence_trace,
    _evidence_lifecycle_trace,
    _reader_boundary_trace,
    _reader_visible_trace,
)
from milai.application.memory_context_core.units import (
    _reader_unit,
    _render_infeasible_context,
...
from milai.application.memory_context_core.windows import (
    ...
    _marginal_conditional_unit_order,
    _order_windows,
)
...
def _compat_evidence_views(
    ...
    *,
    ...
    target = getattr(facade, "_evidence_views", _evidence_views)
    return cast(Callable[..., list[EvidenceView]], target)(
        items,
        query,
        query_terms,
...
class MemoryContextCompiler:
    ...
    def plan(
        ...
        *,
        ...
        evidence_views = _compat_evidence_views(
            items,
            request.query,
            query_terms,
            member_enumeration=member_enumeration,
    ...
    def _compile_legacy(
        ...
        *,
        ...
        if len(items) == len(baseline_items) and all(
            ...
            baseline_evidence_views = _compat_evidence_views(
                baseline_items,
                request.query,
                query_terms,
                member_enumeration=member_enumeration,
