...
def test_event_point_scan_returns_context_and_proof_without_raw_operator_authority() -> None:
    ...
    snapshot = {
        ...
        "items": [
            {
                "evidence_id": "espresso-machine-purchase",
                "source_ref": "memory://session/espresso-machine/turn/0",
                "subject_id": "espresso-machine",
                "observed_at": "2023-03-15T19:38:00+00:00",
                "captured_at": "2023-03-15T19:38:01+00:00",
                "content": "Today I got an espresso machine.",
                "speaker": "user",
                "speaker_source": "STRUCTURED_TURN_METADATA",
                "source_context": {
                    "session_id": "memory://session/espresso-machine",
                    "turn_id": "memory://session/espresso-machine:t0",
                },
    ...
    assert execution.derived_result["status"] == "ABSTAINED"
    assert execution.derived_result["accepted_input_evidence_ids"] == []
