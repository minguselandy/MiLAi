...
def test_raw_temporal_interpretations_are_diagnostic_not_operator_inputs() -> None:
...
def test_metalinguistic_diagnostic_never_promotes_raw_temporal_prose() -> None:
    plan = QueryPlanner().plan(
        _request(
