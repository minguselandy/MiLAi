    ...
    evidence = [
        {
            ...
            "content": (
                "I spent exactly $60 on coffee mugs for my coworkers."
            ),
            "speaker": "assistant",
        ...
        },
        {
            ...
            "content": ("I purchased exactly 5 coffee mugs with printed jokes for my coworkers."),
            "speaker": "tool",
            "speaker_source": "STRUCTURED_TURN_METADATA",
        },
        {
    ...
    ambiguous = compose_divide_evidence_values(
        ...
        [
            ...
            },
            {
                ...
                "subject_id": "fixture-user",
                "source_ref": "memory://c",
                "content": "user: I purchased exactly 5 coffee mugs.",
            },
        ],
    )
