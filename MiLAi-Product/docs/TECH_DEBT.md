...
| Runtime vs Host/provider trace ownership | NEEDS_REVALIDATION | [Trace Ownership v1 offline candidate](reference/trace-ownership-v1.md) 与 Lab joiner 已有离线合同；真实 owner export、cache provenance 和 Product-owned executable receipt 尚待完成，不能以 synthetic tests 关闭 |
