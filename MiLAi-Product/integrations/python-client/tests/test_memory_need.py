...
def test_query_only_shadow_is_task_free_and_does_not_route(
    ...
    assert result.interpreter_version == "query-only-shadow-v2"


def test_explicit_read_is_required_for_every_nonempty_query() -> None:
    ...
    assert result.reason_code == "EXPLICIT_READ_MEMORY_REQUIRED"
